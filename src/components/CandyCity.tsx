...
function CameraController({ enabled }: { enabled: boolean }) {
  ...
  const targetPos = useRef(new THREE.Vector3(0, 280, 280));
  ...
  useEffect(() => {
    ...
    if (selectedStock) {
      ...
      targetPos.current.set(0, 280, 280);
